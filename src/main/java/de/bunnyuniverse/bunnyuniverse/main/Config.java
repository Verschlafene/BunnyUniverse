    ...
    public static void createDefaultScoreboard() {
        ...
        if (!file.exists()) {
            try {
                ...
                score6.add(ChatColor.GRAY + "> " + ChatColor.RED + "Date:");
                score6.add(ChatColor.GRAY + "> " + ChatColor.RED + "Server TPS:");
                score6.add(ChatColor.GRAY + "> " + ChatColor.RED + "Server RAM:");
                ...
                score7.add(ChatColor.GRAY + ">> " + ChatColor.DARK_RED + "%date%");
                score7.add(ChatColor.GRAY + ">> " + ChatColor.DARK_RED + "%server_tps%");
                score7.add(ChatColor.GRAY + ">> " + ChatColor.DARK_RED + "%mem_used%" + ChatColor.GRAY + "/" + ChatColor.DARK_RED + "%mem_total%");
